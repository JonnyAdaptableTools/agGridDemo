...
export declare abstract class AlertBase implements IAlert {
    Header: string;
    Msg: string;
    MessageType: MessageType;
}
export declare class ErrorAlert extends AlertBase implements IAlert {
    constructor();
}
export declare class WarningAlert extends AlertBase implements IAlert {
    constructor();
}
export declare class InfoAlert extends AlertBase implements IAlert {
    constructor();
}
