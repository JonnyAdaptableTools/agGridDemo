...
export declare module Helper {
    function getCharFromKey(event: JQueryKeyEventObject): string;
    function getCharFromKey(event: KeyboardEvent): string;
    function getStringRepresentionFromKey(event: JQueryKeyEventObject | KeyboardEvent): string;
